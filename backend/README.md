...
## Project Structure
    ...
    ├── riley_sennott_app_36753  # Django project configurations
...
1. Clone this repo and `cd riley_sennott_app_36753`
...
2. Clone this repo and `cd riley_sennott_app_36753`
